...
export declare function persistPromptReminder(reminder: PromptReminder): Promise<PromptReminder>;
export declare function getPromptReminder(promptUuid: string): Promise<PromptReminder>;
