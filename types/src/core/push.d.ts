...
export declare function getCurrentSubscriptionState(ctx: Context): Promise<PushSubscriptionState>;
export declare function handleAutoResubscription(ctx: Context): Promise<void>;
