                ...
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, core_1.getInstallId)()
                            ...
                            if (installId !== config.originalVisitorId) {
                                (0, core_1.setInstallId)(config.originalVisitorId);
                            }
                        })];
                    case 1:
                        _a.sent();
                        ...
                        return [4 /*yield*/, (0, core_1.getUserId)()
                                ...
                                if (userId !== config.customerId) {
                                    (0, core_1.associateUser)(_this.context, config.customerId);
                                }
                            })];
                    case 2:
                        _a.sent();
